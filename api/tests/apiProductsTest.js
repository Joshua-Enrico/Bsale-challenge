...
it("testing get method /api/products/search/paginate/:search endpoint", (done) => {
  request(api)
    .get("/api/products/search/bebida")
    .set("Accept", "application/json")
    .expect("Content-Type", /json/)
    .expect(200, done);
});
...
it("testing get method /api/products/search/paginate/:search endpoint", (done) => {
  request(api)
    .get("/api/products/search/paginate/pisco?page=2&size=8")
    .set("Accept", "application/json")
    .expect("Content-Type", /json/)
    .expect(200, done);
});
...
it("testing get method /api/products/search/paginate/:search endpoint manejo de errores", (done) => {
  request(api)
    .get("/api/products/search/paginate/pisco?page=S&size=8")
    .set("Accept", "application/json")
    .expect("Content-Type", "text/html; charset=utf-8")
    .expect(400, done);
});
...
it("testing get method /api/products/search/paginate/:search endpoint manejo de errores", (done) => {
  request(api)
    .get("/api/products/search/paginate/pisco?page=1&size=S")
    .set("Accept", "application/json")
    .expect("Content-Type", "text/html; charset=utf-8")
    .expect(400, done);
});
